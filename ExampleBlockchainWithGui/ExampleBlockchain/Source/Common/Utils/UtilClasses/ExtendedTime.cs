...
namespace BlockchainApp.Source.Common.Utils.UtilClasses
{
    ...
    public struct UnixTimestamp : IComparable<UnixTimestamp>
    {
        ...
        public string ToNoDecimalString() => _timeStamp.ToInt().ToString();
        ...
        {
            return ut1.ToDateTime().Subtract(ut2.ToDateTime());
        }

        public static UnixTimestamp operator +(UnixTimestamp ut, TimeSpan ts)
        {
            return ut.ToDateTime().Add(ts).ToUnixTimestamp();
        }

        public static UnixTimestamp operator +(UnixTimestamp ut, int milliseconds)
        {
            return ut.ToDateTime().AddMilliseconds(milliseconds).ToUnixTimestamp();
        }
        ...
        public static UnixTimestamp operator -(UnixTimestamp ut, TimeSpan ts)
        {
            return ut.ToDateTime().Subtract(ts).ToUnixTimestamp();
        }
        ...
        public ExtendedTime ToExtendedTime(TimeZoneKind timeZone = TimeZoneKind.UTC) => new ExtendedTime(this, timeZone);
